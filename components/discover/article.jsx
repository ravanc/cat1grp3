...
const Article = ({ category, title, image, author, authorImg, date, duration }) => {
  const [isBookmarked, setIsBookmarked] = useState(false);

  return (
    <ScrollView 
      showsVerticalScrollIndicator={false} 
      className='flex-column w-[90%] mx-auto'
